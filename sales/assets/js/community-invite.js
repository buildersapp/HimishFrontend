/******************************************* */
// Message Template
const allowedPlaceholders = ["[COMMUNITY_NAME]", "[COMMUNITY_LOCATION]", "[INVITE_LINK]"];
...
$(document).ready(function() {
    ...
    $("#emailInviteForm").on("submit", function(e) {
        ...
        const replacements = {
            ...
            "[COMMUNITY_LOCATION]": $("#communityLocation").val() || "",
...
function copyMessageTemplate(editorId, editors) {
    ...
    formattedText = formattedText.replace(/\[(COMMUNITY_NAME|COMMUNITY_LOCATION|INVITE_LINK)\]/g, (match) => {
        switch(match) {
            case "[COMMUNITY_NAME]":
                return $("#communityName").val();
            case "[COMMUNITY_LOCATION]":
                return $("#communityLocation").val(); // will be blank if empty
            case "[INVITE_LINK]":

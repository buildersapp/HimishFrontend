...
```
<script type="text/javascript" src="jquery.js?v=<?= time() ?>"></script>
<script type="text/javascript" src="moment.js?v=<?= time() ?>"></script>
<script type="text/javascript" src="daterangepicker.js?v=<?= time() ?>"></script>
